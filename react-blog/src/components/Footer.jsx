        ...
        <div className="grid mb-8 lg:grid-cols-6">
          ...
          <div className="md:max-w-md lg:col-span-2 lg:mt-0 mt-5">
            ...
            <p className="mt-4 text-sm text-gray-500">
              ...
              earum deserunt aspernatur voluptatibus nihil! Blanditiis numquam
              tempore impedit provident reiciendis repellendus, consectetur
              voluptas, aliquam cumque sapiente aspernatur deleniti doloremque!
            </p>
          </div>
        </div>
